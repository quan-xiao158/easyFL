...
def plot_data(record_list, line_names, title=None):
    ...
    plt.savefig("./photo/lambda_ours_plot.png",  bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    custom_filenames = ["FedAsync_0.3b_10t","FedAsync_0.3b_40t",  "FedAsync_0.3b_100t", "FedAsync_0.7b_10t", "FedAsync_0.7b_40t", "FedAsync_0.7b_100t"]

    # 加载数据
    record_list, line_names = load_json_data_by_filenames(custom_filenames, folder_path)

    # 绘制图表
    plot_data(record_list, line_names, title="(e) FedAsync平均陈旧度")