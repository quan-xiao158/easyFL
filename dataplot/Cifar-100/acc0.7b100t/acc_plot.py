...
def plot_data(record_list, line_names, title=None):
    ...
    plt.savefig("./photo/acc_7b100t_plot.png", bbox_inches='tight', dpi=300)  # 确保保存为PNG
    plt.show()
...
if __name__ == "__main__":
    ...
    custom_filenames = ["FedAsync_0.7b_100t","KAFL_0.7b_100t", "ca2fl_0.7b_100t", "FedBuff_0.7b_100t", "ours_0.7b_100t"]

    # 加载数据
    record_list, line_names = load_json_data_by_filenames(custom_filenames, folder_path)

    # 绘制图表
    plot_data(record_list, line_names, title="(f) 0.7b100t客户端异构设置")