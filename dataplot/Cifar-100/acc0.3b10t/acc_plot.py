...
def plot_data(record_list, line_names, title=None):
    ...
    plt.savefig("./photo/acc_3b10t_plot.png", bbox_inches='tight', dpi=300)  # 确保保存为PNG
    plt.show()
...
if __name__ == "__main__":
    ...
    custom_filenames = ["FedAsync_0.3b_10t","KAFL_0.3b_10t", "ca2fl_0.3b_10t", "FedBuff_0.3b_10t", "ours_0.3b_10t"]

    # 加载数据
    record_list, line_names = load_json_data_by_filenames(custom_filenames, folder_path)

    # 绘制图表
    plot_data(record_list, line_names, title="(a) 0.3b10t客户端异构设置")