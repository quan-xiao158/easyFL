...
def plot_data(record_list, line_names, title=None):
    ...
    plt.savefig("./photo/acc_7b40t_plot.png", bbox_inches='tight', dpi=300)  # 确保保存为PNG
    plt.show()
...
if __name__ == "__main__":
    ...
    custom_filenames = ["FedAsync_0.7b_40t","KAFL_0.7b_40t", "ca2fl_0.7b_40t", "FedBuff_0.7b_40t", "ours_0.7b_40t"]

    # 加载数据
    record_list, line_names = load_json_data_by_filenames(custom_filenames, folder_path)

    # 绘制图表
    plot_data(record_list, line_names, title="(e) 0.7b40t客户端异构设置")