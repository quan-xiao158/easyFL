...
def plot_data(record_list, line_names, title=None):
    ...
    plt.savefig("./photo/lambda_ca2fl_plot.png",  bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    custom_filenames = ["ca2fl_0.3b_10t", "ca2fl_0.3b_40t","ca2fl_0.3b_100t", "ca2fl_0.7b_10t", "ca2fl_0.7b_40t","ca2fl_0.7b_100t"]

    # 加载数据
    record_list, line_names = load_json_data_by_filenames(custom_filenames, folder_path)

    # 绘制图表
    plot_data(record_list, line_names, title="(c) ca2fl平均陈旧度")