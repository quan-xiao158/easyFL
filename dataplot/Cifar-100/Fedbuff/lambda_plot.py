    ...
    for name in filenames:
        ...
        try:
            with open(file_path, 'r', encoding='utf-8') as json_file:
                ...
                if 'lambda' in data:
                    record_list.append(data['lambda'][:601])
                else:
...
def plot_data(record_list, line_names, title=None):
    ...
    plt.savefig("./photo/lambda_FedBuff_plot.png", bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    custom_filenames = ["FedBuff_0.3b_10t", "FedBuff_0.3b_40t", "FedBuff_0.3b_100t", "FedBuff_0.7b_10t","FedBuff_0.7b_40t", "FedBuff_0.7b_100t"]
    # 加载数据
    record_list, line_names = load_json_data_by_filenames(custom_filenames, folder_path)

    # 绘制图表
    plot_data(record_list, line_names, title="(b) FedBuff平均陈旧度")