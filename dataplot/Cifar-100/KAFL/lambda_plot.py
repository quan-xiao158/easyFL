...
def plot_data(record_list, line_names, title=None):
    ...
    plt.savefig("./photo/lambda_KAFL_plot.png",  bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    custom_filenames = ["KAFL_0.3b_10t","KAFL_0.3b_40t", "KAFL_0.3b_100t", "KAFL_0.7b_10t", "KAFL_0.7b_40t","KAFL_0.7b_100t"]
