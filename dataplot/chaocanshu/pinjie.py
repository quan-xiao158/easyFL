...
# 打开三张图片
img1 = Image.open("./FashionMNIST/photo/acc_7b10t_plot.png")
img2 = Image.open("./Cifar10/photo/acc_3b100t_plot.png")
img3 = Image.open("./CIFAR-100/photo/acc_7b10t_plot.png")
