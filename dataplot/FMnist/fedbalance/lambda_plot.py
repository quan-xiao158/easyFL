...
def plot_data(record_list, line_names, title=None):
    ...
    plt.savefig("./photo/lambda_ours_plot.png",  bbox_inches='tight',dpi=300)
    plt.show()
...
if __name__ == "__main__":
    ...
    custom_filenames = ["ours_0.3b_10t", "ours_0.3b_100t", "ours_0.7b_10t", "ours_0.7b_100t"]

    # 加载数据
    record_list, line_names = load_json_data_by_filenames(custom_filenames, folder_path)

    # 绘制图表
    plot_data(record_list, line_names, title="(d) ours平均陈旧度")