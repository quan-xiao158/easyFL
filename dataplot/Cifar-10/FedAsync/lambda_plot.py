...
def plot_data(record_list, line_names, x_ticks,title):
    ...
    ax.set_ylabel('Average Obsolescence')
    ax.grid(True)  # 添加网格线
...
if __name__ == "__main__":
    folder_path = './'  # 文件夹路径
    line_names = ["FedAsync_0.3b_10t", "FedAsync_0.3b_40t", "FedAsync_0.3b_100t", "FedAsync_0.7b_10t","FedAsync_0.7b_40t", "FedAsync_0.7b_100t"]
    ...
    # 绘制图表
    plot_data(averaged_record_list, line_names, x_ticks,title="(e) FedAsync平均陈旧度")