...
def plot_data(record_list, line_names, x_ticks,title):
    ...
    plt.savefig("./photo/acc_3b10t_plot", bbox_inches='tight',dpi=300)
    plt.show()

if __name__ == "__main__":
    folder_path = './'  # 文件夹路径
    line_names = ["FedAsync_0.3b_10t","KAFL_0.3b_10t", "ca2fl_0.3b_10t", "FedBuff_0.3b_10t", "ours_0.3b_10t"]
    ...
    # 绘制图表
    plot_data(averaged_record_list, line_names, x_ticks,title="(a) 0.3b10t客户端异构设置")