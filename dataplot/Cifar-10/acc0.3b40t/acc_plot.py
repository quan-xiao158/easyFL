...
def plot_data(record_list, line_names, x_ticks,title):
    ...
    plt.savefig("./photo/acc_3b40t_plot", bbox_inches='tight',dpi=300)
    plt.show()

if __name__ == "__main__":
    folder_path = './'  # 文件夹路径
    line_names = ["FedAsync_0.3b_40t","KAFL_0.3b_40t", "ca2fl_0.3b_40t", "FedBuff_0.3b_40t", "ours_0.3b_40t"]
    ...
    # 绘制图表
    plot_data(averaged_record_list, line_names, x_ticks,title="(b) 0.3b40t客户端异构设置")