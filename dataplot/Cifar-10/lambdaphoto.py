...
# 打开两张图片
img_left = Image.open("./KAFL/photo/lambda_plot.png")
img_right = Image.open("./Fedbuff/photo/lambda_plot.png")
# img_left = Image.open("./c2fl/photo/lambda_plot.png")
# img_right = Image.open("./fedbalance/photo/lambda_plot.png")
...
# 保存新图
new_img.save("lambda_combined3.jpg")
