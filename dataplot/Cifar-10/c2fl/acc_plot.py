...
def plot_data(record_list, line_names, title=None):
    ...
    plt.savefig("./photo/acc_ca2fl_plot", dpi=600, bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    # 绘制图表
    plot_data(record_list, line_names, title="The accuracy of the ca2fl algorithm on the Fashion-MNIST dataset")