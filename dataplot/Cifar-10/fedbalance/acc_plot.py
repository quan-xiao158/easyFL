...
def plot_data(record_list, line_names, title=None):
    ...
    plt.savefig("./photo/acc_ours_plot", dpi=600, bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    custom_filenames = ["ours_0.3b_10t", "ours_0.3b_100t","ours_0.3b_40t", "ours_0.7b_10t","ours_0.7b_40t", "ours_0.7b_100t"]

    # 加载数据
    record_list, line_names = load_json_data_by_filenames(custom_filenames, folder_path)

    # 绘制图表
    plot_data(record_list, line_names, title="The accuracy of our algorithm on the Fashion-MNIST dataset")