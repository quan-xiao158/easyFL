...
if __name__ == "__main__":
    ...
    line_names = ["ours_0.3b_10t", "ours_0.3b_40t", "ours_0.3b_100t", "ours_0.7b_10t","ours_0.7b_40t", "ours_0.7b_100t"]
    ...
    # 绘制图表
    plot_data(averaged_record_list, line_names, x_ticks,title="(d) ours平均陈旧度")