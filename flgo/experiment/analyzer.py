...
def load_records(task:str, algorithm: Union[Union[str, List[str]]], filter:dict={}):
    r"""
...
def delete_records(task:str, algorithm: Union[Union[str, List[str]]], filter:dict={}):
    r"""
...
class Table:
    ...
    def get_column(self, idx: Union[str, int]):
