...
if __name__ == '__main__':
    ...
    fedavg_runner = flgo.init(task=task,Logger=logger, algorithm=fedasync, option={'num_rounds': 4000, 'num_epochs': 20, 'cpu': 0,'proportion':0.2,'b':0.7,'t':20,"client_weight":"random55"},model=rs)
    fedavg_runner.run()
